...
export default function MarketWelcomePage({ params }: MarketWelcomeProps) {
  ...
  const marketContent = {
    en: {
      title: 'Welcome to Green Project - English Market',
      description: 'This is the English market homepage for Project A.',
    },
    ca: {
      title: 'Welcome to Green Project - Canadian Market',
      description: 'This is the Canadian market homepage for Project A.',
    },
  };
